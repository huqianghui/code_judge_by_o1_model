...
api_version = os.getenv("AZURE_OPENAI_API_VERSION","2024-10-01-preview") # this might change in the future
deployment_name = os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME","o1-preview")
